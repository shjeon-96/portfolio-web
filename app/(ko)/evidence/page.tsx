...
export const metadata = {
  title: '구현 근거',
  description: '프론트엔드 개발자로서 판단 가능한 대표 구현 영역, 역할, 기술 신호, 검증 근거를 정리한 페이지입니다.',
};
  ...
  return (
    <main className="page-shell">
      <SectionHeading
        ...
        description="설명만 읽히는 포트폴리오가 아니라, 어떤 제품 영역을 맡았고 어떤 프론트엔드 신호와 검증이 있었는지 바로 확인할 수 있게 정리했습니다."
      />
      <GuidePanel
