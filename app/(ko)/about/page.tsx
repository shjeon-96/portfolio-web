  ...
  return (
    <main className="page-shell page-narrow">
      <SectionHeading
        ...
        description="에디터 엔진, 운영 도구, 배포 산출물, AI 에이전트를 활용한 개발 흐름이 현재 가장 강한 축입니다."
      />
        ...
        <article className="surface-panel p-6">
          ...
          <div className="mt-4 space-y-5 text-copy">
            <p>
              ...
              컴포넌트 변형, 캔버스 조작, 데이터 바인딩, 내보내기와 배포 파이프라인을 다뤘습니다. 이전에는 관리자
              대시보드, AI 리뷰 운영, 결제·정산 흐름, 실시간 운영 화면, 백오피스 마이그레이션을 개발했습니다.
            </p>
            <p>
              복잡한 제품 UI를 단순 화면 구현으로 끝내지 않고 상태 모델, 검증 흐름, 릴리즈 경계까지 함께 봅니다.
              B2B SaaS, 에디터/빌더 제품, 모바일 제품 플랫폼, AI 개발 흐름처럼 여러 경계가 맞물리는 제품을 다뤄왔습니다.
            </p>
          </div>
        </article>
